...
struct FetchErrorMessage {

    static let type: MessageType = .fetchError
    ...
    static func decode(from payload: Data) throws -> FetchErrorMessage {
        ...
        return FetchErrorMessage(requestID: requestID, errorCode: errorCode, reasonPhrase: reasonPhrase)
    }
}
